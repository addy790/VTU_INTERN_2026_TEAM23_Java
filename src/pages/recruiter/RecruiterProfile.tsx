        ...
        <form onSubmit={handleSave} className="surface-card p-8 space-y-8">
          <div className="flex items-center gap-6 pb-6 border-b border-border">
            ...
            <div>
              ...
              <p className="text-muted-foreground">{profile.designation} · {profile.company}</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input value={profile.phone} onChange={e => setProfile({...profile, phone: e.target.value})} placeholder="+1 234567890" />
            </div>
            <div className="space-y-2">
              <Label>Company</Label>
